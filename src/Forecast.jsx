  ...
  constructor(props) {
    ...
    this.state = {
      ...
      myItems: [
        ...
        moment(this.props.results[0].forecast[3].ftime).format("h:mm"),
        moment(this.props.results[0].forecast[4].ftime).format("h:mm"),
        moment(this.props.results[0].forecast[5].ftime).format("h:mm"),
        moment(this.props.results[0].forecast[6].ftime).format("h:mm")
      ]
    }
  }
  render() {
    return (
      ...
      {this.state.myItems.map((days, index) => {
          return (
            <li className="Forecast-item" key={index}>
             <p>{days}</p>
              <p><i className={`WeatherCard-icon wi ${getIcon(this.props.results[0].forecast[0].W)}`}></i></p>
              <p>13°</p>
            </li>
          );
        })}
